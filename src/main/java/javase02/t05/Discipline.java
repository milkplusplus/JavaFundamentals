...
public enum Discipline {
    ...
    private static DisciplineListener findBestListenerGrade(LinkedList<DisciplineListener> gradeList) {
            ...
            int counter = 0;
            for (; (counter < gradeList.size()) && (gradeList.get(counter).getDiscipline().getGradeType() == GradeType.INTEGER); counter++) {
...
//        gradeList.sort(Comparator.comparingInt(d -> d.getDiscipline().getGradeType().ordinal()));
//        DisciplineListener maxInteger = null;
//        DisciplineListener maxDouble = null;
//        DisciplineListener current = gradeList.getFirst();
//        int counter = 0;
//
//
//        for (; (counter < gradeList.size()) && (current.getDiscipline().gradeType == GradeType.INTEGER); counter++) {
//            if ()
//            IntegerGradeList.add(current);
//            current = gradeList.get(counter);
//        }
//        for (; counter < gradeList.size(); counter++) {
